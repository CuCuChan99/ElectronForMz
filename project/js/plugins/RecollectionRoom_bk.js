...
(() => {
    ...
    class Scene_Recollection extends Scene_MenuBase {
        ...
        _updateHeaderStats() {
            ...
            x -= pageTextW;
            b.drawText(pageText, x, 78, pageTextW, 24);

            b.fontSize = 24;
            b.textColor = CONFIG.accentColor;
            const pageNumW = b.measureTextWidth(pageNum) + 6;
            x -= pageNumW;
            b.drawText(pageNum, x, 74, pageNumW, 28);
            ...
            x -= pageLabelW;
            b.drawText(pageLabel, x, 78, pageLabelW, 24);
            ...
            x -= uTextW;
            b.drawText(unlockedText, x, 78, uTextW, 24);

            b.fontSize = 24;
            b.textColor = CONFIG.accentColor;
            const uNumW = b.measureTextWidth(unlockedNum) + 6;
            x -= uNumW;
            b.drawText(unlockedNum, x, 74, uNumW, 28);
            ...
            x -= uLabelW;
            b.drawText(uLabel, x, 78, uLabelW, 24);
        }
        ...
        _updateFooterInfo() {
            ...
            b.clearRect(rightX, 15, clearW, 24);
            ...
            b.fontSize = 16;
            b.textColor = CONFIG.mutedColor;
            b.drawText(text, rightX, 15, clearW, 24, 'right');
        }
